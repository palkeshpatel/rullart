...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('cartitems', function (Blueprint $table) {
            ...
            $table->decimal('actualprice', 18, 3)->nullable();
            ...
            $table->decimal('giftproductprice', 18, 3)->default(0);
            $table->decimal('giftproduct2price', 18, 3)->default(0);
            $table->decimal('giftproduct3price', 18, 3)->default(0);
            $table->float('giftproduct4price')->nullable();
            $table->decimal('giftboxprice', 18, 3)->default(0);
            ...
            $table->integer('gift_type')->nullable()->default(0);
        });
    }
