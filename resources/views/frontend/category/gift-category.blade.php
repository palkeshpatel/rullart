            ...
            @if ($productcnt >= 0)
                <div class="container-fluid">
                    ...
                    <div class="row" style="display:flex; flex-wrap:wrap; clear: both;">
                        @if ($productcnt > 0)
                            <div class="col-md-12 col-catalog noborder">
                                @if (!empty($collections['category']->category_description ?? ''))
                                    <div class="hidden-sm hidden-xs" style="margin:0 0 30px 0 !important;">
                                        <p class="text-center m-3 fs-3">
                                            {{ $collections['category']->category_description ?? '' }}</p>
                                    </div>
                                @endif
                                            ...
                                            <div class="product-item">
                                                <a
                                                    ...
                                                    @if ($discount > 0)
                                                        @php
                                                            $discountPercent =
                                                                is_numeric($discount) && $price > 0
                                                                    ? round(($discount / $price) * 100)
                                                                    : 0;
                                                        @endphp
                                                        <span
                                ...
                                @php
                                    $showfooter =
                                        $totalpage > $page && request()->get('showall', '') != 'yes' ? '' : 'hidden';
                                @endphp
                                    ...
                                    <div class="other-details-accordion">
                                        <div class="accordion-item">
                                            ...
                                            <label for="acc1" class="accordion-label">
                                                ...
                                                <span
                                                    class="title">{{ $collections['category']->category_other_details_title ?? '' }}</span>
                                            </label>
