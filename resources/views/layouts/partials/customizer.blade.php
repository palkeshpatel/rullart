            ...
            <div class="row g-3">
                <div class="col-6">
                    <div class="form-check card-radio">
                        <input class="form-check-input" type="radio" name="data-skin" id="demo-skin-classic"
                            value="classic">
                ...
                <div class="col-6">
                    <div class="form-check card-radio pe-none">
                        <input class="form-check-input" disabled type="radio" name="data-skin" id="demo-skin-galaxy"
                            value="galaxy">
