                ...
                <div class="row g-0">
                    ...
                    <div class="col-xxl-4">
                        ...
                        <div class="text-center my-3">
                            <a href="{{ route('admin.products')}}" class="link-reset text-decoration-underline fw-semibold link-offset-3">
        ...
        <div data-table data-table-rows-per-page="5" class="card">
            <div class="card-header justify-content-between align-items-center border-dashed">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.product')}}" class="btn btn-sm btn-soft-secondary">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="fs-base my-1"><a href="{{ route('admin.product')}}" class="text-body">Smart Watch</a></h5>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="fs-base my-1"><a href="{{ route('admin.product')}}" class="text-body">Bluetooth Speaker</a>
                                            </h5>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="fs-base my-1"><a href="{{ route('admin.product')}}" class="text-body">Gaming Mouse</a></h5>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="fs-base my-1"><a href="{{ route('admin.product')}}" class="text-body">4K Action Camera</a>
                                            </h5>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="fs-base my-1"><a href="{{ route('admin.product')}}" class="text-body">Fitness Tracker Band</a>
                                            </h5>
                                            <span class="text-muted fs-xs">Wearables</span>
                                        </div>
                                    </div>
