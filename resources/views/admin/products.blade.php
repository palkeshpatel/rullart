@extends('layouts.vertical', ['title' => 'Admin Products'])
        ...
        <div data-table data-table-rows-per-page="8" class="card">
            <div class="card-header border-light justify-content-between">
                ...
                <div class="d-flex gap-1">
                    <a href="{{ route('admin.products')}}" class="btn btn-primary btn-icon">
                        <i data-lucide="list" class="fs-lg"></i>
                    </a>
                    <a href="{{ route('admin.product')}}" class="btn btn-danger ms-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="product" href="{{ route('admin.product')}}" class="link-reset">Wireless
                                                Earbuds</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="#" class="link-reset fw-semibold">(87)</a></span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="product" href="{{ route('admin.product')}}" class="link-reset">Smart
                                                LED Desk Lamp</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="#" class="link-reset fw-semibold">(54)</a></span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="product" href="{{ route('admin.product')}}" class="link-reset">Men's
                                                Running Shoes</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="#" class="link-reset fw-semibold">(142)</a></span>
                            </td>
                            <td><span class="badge badge-soft-success fs-xxs">Published</span></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="product" href="{{ route('admin.product')}}" class="link-reset">Fitness
                                                Tracker Watch</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="#" class="link-reset fw-semibold">(89)</a></span>
                            </td>
                            <td><span class="badge badge-soft-success fs-xxs">Published</span></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="product" href="{{ route('admin.product')}}" class="link-reset">Gaming
                                                Mouse RGB</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="#" class="link-reset fw-semibold">(102)</a></span>
                            </td>
                            <td><span class="badge badge-soft-success fs-xxs">Published</span></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="product" href="{{ route('admin.product')}}" class="link-reset">Modern
                                                Lounge Chair</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="#" class="link-reset fw-semibold">(27)</a></span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="product" href="{{ route('admin.product')}}" class="link-reset">Plush
                                                Toy Bear</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="#" class="link-reset fw-semibold">(120)</a></span>
                            </td>
                            <td><span class="badge badge-soft-success fs-xxs">Published</span></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="product" href="{{ route('admin.product')}}" class="link-reset">55"
                                                Ultra HD Smart TV</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="#" class="link-reset fw-semibold">(88)</a></span>
                            </td>
                            <td><span class="badge badge-soft-success fs-xxs">Published</span></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="product" href="{{ route('admin.product')}}" class="link-reset">Apple
                                                iMac 24" M3</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="#" class="link-reset fw-semibold">(16)</a></span>
                            </td>
                            <td><span class="badge badge-soft-warning fs-xxs">Pending</span></td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="#" class="link-reset fw-semibold">(65)</a></span>
                            </td>
                            <td><span class="badge badge-soft-success fs-xxs">Published</span></td>
