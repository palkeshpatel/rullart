@extends('layouts.vertical', ['title' => 'Update Terms & Conditions'])

@section('content')
    @include('layouts.partials/page-title', ['title' => 'Terms & Conditions'])
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="pageForm" method="POST" 
                        action="{{ route('admin.pages.terms.update') }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="pagetitle" class="form-control" 
                                        value="{{ old('pagetitle', $page->pagetitle ?? 'Terms & Conditions') }}" required>
        ...
        (function() {
            function initPageScript() {
                ...
                $(document).ready(function() {
                    console.log('✅ Document ready for Terms & Conditions Page');
