@extends('layouts.vertical', ['title' => 'Update Contact Us'])

@section('content')
    @include('layouts.partials/page-title', ['title' => 'Contact Us'])
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="pageForm" method="POST" 
                        action="{{ route('admin.pages.contactus.update') }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="pagetitle" class="form-control" 
                                        value="{{ old('pagetitle', $page->pagetitle ?? 'Contact Us') }}" required>
        ...
        (function() {
            function initPageScript() {
                ...
                $(document).ready(function() {
                    console.log('✅ Document ready for Contact Us Page');
