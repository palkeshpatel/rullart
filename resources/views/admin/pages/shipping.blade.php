@extends('layouts.vertical', ['title' => 'Update Shipping'])

@section('content')
    @include('layouts.partials/page-title', ['title' => 'Shipping'])

    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Shipping</h4>
                </div>
                <div class="card-body">
                    <form id="pageForm" method="POST" 
                        action="{{ route('admin.pages.shipping.update') }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="pagetitle" class="form-control" 
                                        value="{{ old('pagetitle', $page->pagetitle ?? 'Shipping') }}" required>
        ...
        (function() {
            function initPageScript() {
                ...
                $(document).ready(function() {
                    console.log('✅ Document ready for Shipping Page');
