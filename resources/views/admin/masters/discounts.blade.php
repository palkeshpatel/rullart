...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <!-- Filters Section -->
            <form method="GET" action="{{ route('admin.discounts') }}" data-table-filters id="discountsFilterForm">
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" name="start_date" class="form-control form-control-sm" data-filter
                                    value="{{ request('start_date') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label mb-1">End Date:</label>
                                <input type="date" name="end_date" class="form-control form-control-sm" data-filter
        ...
        (function() {
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.getElementById('perPageSelect')?.addEventListener('change', function() {
                    const form = document.getElementById('discountsFilterForm');
                    ...
                    AdminAjax.loadTable('{{ route('admin.discounts') }}', document.querySelector('.table-container'), {
