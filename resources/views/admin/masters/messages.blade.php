...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <!-- Filters Section -->
            <form method="GET" action="{{ route('admin.messages') }}" data-table-filters id="messagesFilterForm">
                <div class="card mb-3">
                    <div class="card-body">
        ...
        (function() {
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.getElementById('perPageSelect')?.addEventListener('change', function() {
                    const form = document.getElementById('messagesFilterForm');
                    ...
                    AdminAjax.loadTable('{{ route('admin.messages') }}', document.querySelector('.table-container'), {
