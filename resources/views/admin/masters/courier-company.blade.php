...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <!-- Filters Section -->
            <form method="GET" action="{{ route('admin.courier-company') }}" data-table-filters id="courierCompanyFilterForm">
                <div class="card mb-3">
                    <div class="card-body">
        ...
        (function() {
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.getElementById('perPageSelect')?.addEventListener('change', function() {
                    ...
                    AdminAjax.loadTable('{{ route('admin.courier-company') }}', document.querySelector('.table-container'), {
