...
<div class="row mb-4">
    <div class="col-12">
        <h5 class="mb-3 border-bottom pb-2 text-primary fw-bold">Basic Information</h5>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <select name="fkcategoryid" id="categorySelect" class="form-select" required>
                ...
                @foreach ($categories as $cat)
                    <option value="{{ $cat->categoryid }}"
                        ...
                        {{ $cat->category }}@if (isset($cat->subcategory_count) && $cat->subcategory_count > 0)
            ...
            <select name="productcategoryid" id="subCategorySelect" class="form-select">
                ...
                @if ($product && $product->productcategoryid)
                    ...
                    @if ($selectedSubCategory)
                        <option value="{{ $selectedSubCategory->categoryid }}" selected>
                            {{ $selectedSubCategory->category }}</option>
                    @endif
                @endif
            </select>
        </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" name="recommend_product_codes" class="form-control"
                value="{{ old('recommend_product_codes', '') }}" placeholder="Enter product codes separated by comma">
        </div>
    </div>
</div>
...
<div class="row mb-4">
    <div class="col-12">
        <h5 class="mb-3 border-bottom pb-2 text-primary fw-bold">Product Details</h5>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
...
<div class="row mb-4">
    <div class="col-12">
        <h5 class="mb-3 border-bottom pb-2 text-primary fw-bold">Size & Quantity</h5>
                ...
                <tbody>
                    @if ($product && $productSizes->count() > 0)
                        ...
                        <tr>
                            <td>
                                <select name="sizes[][filtervalueid]" class="form-select form-select-sm">
                                    ...
                                    @foreach ($sizes as $size)
                                        <option value="{{ $size->filtervalueid }}"
                                            {{ $firstSize->fkfiltervalueid == $size->filtervalueid ? 'selected' : '' }}>
                                            {{ $size->filtervalue }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <td>
                                <input type="number" name="sizes[][qty]" class="form-control form-control-sm"
                                    min="0" value="{{ $firstSize->qty }}">
                            </td>
                            <td>
                                <input type="text" name="sizes[][barcode]" class="form-control form-control-sm"
                                    value="{{ $firstSize->barcode }}">
                            </td>
                        </tr>
                    @else
                        <tr>
...
<div class="row mb-4">
    <div class="col-12">
        <h5 class="mb-3 border-bottom pb-2 text-primary fw-bold">Pricing & Discount</h5>
    </div>
    <div class="col-md-3">
        <div class="mb-3">
...
<div class="row mb-4">
    <div class="col-12">
        <h5 class="mb-3 border-bottom pb-2 text-primary fw-bold">Status & Flags</h5>
    </div>
    <div class="col-md-3">
        <div class="form-check form-switch mb-3">
            <input class="form-check-input" type="checkbox" name="ispublished" value="1" id="ispublished"
    ...
    <div class="col-md-3">
        <div class="form-check form-switch mb-3">
            <input class="form-check-input" type="checkbox" name="ispopular" value="1" id="ispopular"
...
<div class="row mb-4">
    <div class="col-12">
        <h5 class="mb-3 border-bottom pb-2 text-primary fw-bold">Product Photos</h5>
    ...
    @for ($i = 1; $i <= 5; $i++)
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="file" name="photo{{ $i }}" id="photo{{ $i }}Input"
                    class="form-control" accept="image/*"
                    onchange="previewProductImage(this, 'photo{{ $i }}Preview')">
                <div class="invalid-feedback"></div>
                    ...
                    <div class="mt-3" id="photo{{ $i }}PreviewContainer" style="display: none;">
                        <div class="position-relative d-inline-block" style="width: 150px; height: 150px;">
                            <img id="photo{{ $i }}Preview"
                                style="width: 150px; height: 150px; object-fit: cover; border-radius: 4px; display: none;">
                        </div>
                    </div>
                @endif
            </div>
...
<div class="row mb-4">
    <div class="col-12">
        <h5 class="mb-3 border-bottom pb-2 text-primary fw-bold">Video</h5>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <label class="form-label">Upload Video Poster</label>
            <input type="file" name="videoposter_file" id="videoposterInput" class="form-control"
                accept="image/*" onchange="previewProductImage(this, 'videoposterPreview')">
            <div class="invalid-feedback"></div>

            @if ($product && $product->videoposter)
                <div class="mt-3 position-relative d-inline-block" id="videoposterPreviewContainer">
                    <div class="position-relative" style="width: 150px; height: 150px;">
                        <img src="{{ asset('storage/upload/product/' . $product->videoposter) }}" alt="Video Poster"
                            id="videoposterPreview"
                            style="width: 150px; height: 150px; object-fit: cover; border-radius: 4px;">
                    </div>
...
<div class="row mb-4">
    <div class="col-12">
        <h5 class="mb-3 border-bottom pb-2 text-primary fw-bold">SEO Meta Information</h5>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
