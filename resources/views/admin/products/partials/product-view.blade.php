    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="productViewModalLabel">Product Details - {{ $product->title }}</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary edit-product-btn" data-product-id="{{ $product->productid }}">
