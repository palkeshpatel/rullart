@extends('layouts.vertical', ['title' => 'Sales Report Monthwise'])

@section('content')
    @include('layouts.partials/page-title', ['title' => 'Sales Report Monthwise List'])

    <div class="row">
        <div class="col-12">
            <!-- Filters Section - Top Bar -->
            <form method="GET" action="{{ route('admin.sales-report-month') }}" data-table-filters id="monthReportFilterForm">
                <div class="card mb-3">
                    <div class="card-body">
            ...
            <div class="card">
                <div class="card-header justify-content-between align-items-center border-dashed">
                    <h4 class="card-title mb-0">Sales Report Monthwise List</h4>
                    <div class="d-flex gap-2">
                        <a href="{{ route('admin.sales-report-month.export', ['format' => 'excel', 'year' => request('year')]) }}" 
                ...
                <div class="card-body">
                    ...
                    <div class="table-container">
                        @include('admin.reports.partials.monthwise-table', ['reports' => $reports])
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('perPageSelect')?.addEventListener('change', function() {
                const form = document.getElementById('monthReportFilterForm');
                ...
                AdminAjax.loadTable('{{ route('admin.sales-report-month') }}', document.querySelector(
                    '.table-container'), {
