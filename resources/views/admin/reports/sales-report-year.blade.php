@extends('layouts.vertical', ['title' => 'Sales Report Yearwise'])

@section('content')
    @include('layouts.partials/page-title', ['title' => 'Sales Report Yearwise List'])
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header justify-content-between align-items-center border-dashed">
                    <h4 class="card-title mb-0">Sales Report Yearwise List</h4>
                    <div class="d-flex gap-2">
                        <a href="{{ route('admin.sales-report-year.export', ['format' => 'excel']) }}" 
                            class="btn btn-success btn-sm" title="Export to Excel">
                            <i class="ti ti-file-excel me-1"></i> Export
                        </a>
                        <a href="{{ route('admin.sales-report-year.export', ['format' => 'pdf']) }}" 
                            class="btn btn-success btn-sm pdf-export-btn" title="Export to PDF" download>
                            <i class="ti ti-file-pdf me-1"></i> PDF
                        </a>
                        <a href="{{ route('admin.sales-report-year.print') }}" 
                ...
                <div class="card-body">
                    ...
                    <div class="table-container">
                        @include('admin.reports.partials.yearwise-table', ['reports' => $reports])
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('perPageSelect')?.addEventListener('change', function() {
                ...
                AdminAjax.loadTable('{{ route('admin.sales-report-year') }}', document.querySelector(
                    '.table-container'), {
